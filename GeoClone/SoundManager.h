...
enum SoundID{EVOLVED_MUSIC, MAIN_MENU_MUSIC, DEADLINE_MUSIC, WAVES_MUSIC, MAIN_MENU_NAV_SOUND, BULLET_SOUND, ENEMY_EXPLODE, BLUE_SPAWN, GREEN_SPAWN, PURPLE_SPAWN, ORANGE_SPAWN };
